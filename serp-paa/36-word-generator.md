# SERP/PAA Framework - Word Generator

- Primary keyword: word generator
- Target URL: /word-generator/
- Cluster: word-finder
...
Do not write a generic article about word generator. Build the answer around the moment when the user is stuck, show exactly what to type, and make the result easy to narrow, copy, or apply back in the game.
